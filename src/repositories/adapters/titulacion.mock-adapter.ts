...
function seedProducts(): Record<string, TitulacionProduct> {
  return {
    'usr-alumno-001': {
          ...
          versions: [
            {
              ...
              authorName: 'Andrea Guadalupe Mendez Guzman',
          ...
          feedback: [
            {
              ...
              authorName: 'Lic. Yesus Eleazar González',
          ...
          deliverables: [
            {
              ...
              files: [{ id: 'f-1', name: 'planteamiento.pdf', kind: 'pdf', version: 1, uploadedById: 'usr-alumno-001', uploadedByName: 'Andrea Guadalupe Mendez Guzman', uploadedAt: '2026-03-14T10:00:00.000Z', url: '#' }],
              evidence: [{ id: 'ev-1', kind: 'reporte', label: 'Reporte semanal 3 — Clase Modelo 1 y Modelo 2', link: '/alumno/reportes/rep-101', syncedAt: '2026-03-12T09:00:00.000Z' }],
          ...
          deliverables: [
            {
              ...
              files: [{ id: 'f-2', name: 'revision-literatura.pdf', kind: 'pdf', version: 1, uploadedById: 'usr-alumno-001', uploadedByName: 'Andrea Guadalupe Mendez Guzman', uploadedAt: '2026-07-20T09:00:00.000Z', url: '#' }],
              evidence: [],
      ...
      history: [
        { id: nextId('h'), actorId: 'usr-alumno-001', actorName: 'Andrea Guadalupe Mendez Guzman', action: 'creo', detail: 'Creó el Producto de Titulación', source: 'Web · Alumno', createdAt: '2026-03-10T09:00:00.000Z' },
        { id: nextId('h'), actorId: 'usr-alumno-001', actorName: 'Andrea Guadalupe Mendez Guzman', action: 'publico', detail: 'Publicó la versión 1 de "Fase 1 — Propuesta"', source: 'Web · Alumno', phaseId: 'fase-1', createdAt: '2026-03-15T09:00:00.000Z' },
        { id: nextId('h'), actorId: 'usr-alumno-001', actorName: 'Andrea Guadalupe Mendez Guzman', action: 'publico', detail: 'Publicó la versión 2 de "Fase 1 — Propuesta"', source: 'Web · Alumno', phaseId: 'fase-1', createdAt: '2026-03-16T09:00:00.000Z' },
        { id: nextId('h'), actorId: 'usr-profesor-001', actorName: 'Lic. Yesus Eleazar González', action: 'aprobo', detail: 'Aprobó "Fase 1 — Propuesta"', source: 'Web · Profesor', phaseId: 'fase-1', createdAt: '2026-03-18T12:00:00.000Z' },
        { id: nextId('h'), actorId: 'usr-alumno-001', actorName: 'Andrea Guadalupe Mendez Guzman', action: 'publico', detail: 'Publicó la versión 1 de "Fase 2 — Marco Teórico"', source: 'Web · Alumno', phaseId: 'fase-2', createdAt: '2026-07-20T09:00:00.000Z' },
      ],
    },
  }
}
