...
export function AdminProfilePage() {
  ...
  return (
    <div className="space-y-6">
      <Breadcrumb items={[{ label: 'Inicio', to: '/admin' }, { label: 'Mi Perfil' }]} />
      <BackLink to="/admin">Volver al Inicio</BackLink>
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground mt-1">Administrador</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card className="p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground mb-1">Nivel de Acceso</p>
        ...
        <Card className="p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-medium">Universidad Imperalianz</p>
            </div>
          </div>
        </Card>
