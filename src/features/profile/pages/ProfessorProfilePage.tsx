...
export function ProfessorProfilePage() {
  ...
  return (
    <div className="space-y-6">
      <Breadcrumb items={[{ label: 'Inicio', to: '/profesor' }, { label: 'Mi Perfil' }]} />
      <BackLink to="/profesor">Volver al Inicio</BackLink>
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground mt-1">Profesor</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card className="p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-medium">Departamento de Administración</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground mb-1">Materias Asignadas</p>
              <p className="font-medium">3 materias</p>
            </div>
          </div>
        </Card>
