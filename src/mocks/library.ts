...
let DOCUMENTS: LibraryDocument[] = [
  ...
  {
    id: 'lib-003',
    title: 'Presentación — Administración Estratégica, Unidad 1',
    fileName: 'unidad-1-admin-estrategica.pptx',
    kind: 'powerpoint',
    ...
    size: 3_400_000,
    url: '#',
    uploadedByName: 'Ing. Carlos Mendoza',
  ...
  {
    id: 'lib-010',
    title: 'Clase grabada — Administración Estratégica, sesión 4',
    fileName: 'clase-admin-estrategica-s4.mp4',
    kind: 'otro',
    ...
    durationMinutes: 52,
    tags: ['clase grabada', 'administración estratégica'],
    version: 1,
    versions: [],
  },
  {
    id: 'lib-011',
    title: 'Clase grabada — Finanzas Corporativas, sesión 2',
    fileName: 'clase-finanzas-s2.mp4',
    kind: 'otro',
    category: 'Clases grabadas',
    ...
    size: 210_000_000,
    url: '#',
    uploadedByName: 'Dr. Roberto Flores',
    createdAt: '2026-07-14T09:00:00.000Z',
    updatedAt: '2026-07-14T09:00:00.000Z',
    durationMinutes: 47,
    tags: ['clase grabada', 'finanzas'],
    version: 1,
    versions: [],
  },
  {
