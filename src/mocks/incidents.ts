  ...
  return [
    {
      ...
      status: 'en_proceso',
      priority: 'media',
      reportedById: 'std-201',
      reportedByName: 'Jorge Ramírez Peña',
      responsibleName: 'Ana Torres Vega',
      createdAt: daysAgo(4),
      updatedAt: daysAgo(1),
      history: [
        { id: nextId('ih'), action: 'Incidencia creada', performedByName: 'Jorge Ramírez Peña', createdAt: daysAgo(4) },
    ...
    },
    {
      ...
      status: 'abierto',
      priority: 'alta',
      reportedById: 'std-203',
      reportedByName: 'Andrés Solís Vega',
      relatedModule: 'Materias',
      createdAt: daysAgo(1),
      updatedAt: daysAgo(1),
      history: [{ id: nextId('ih'), action: 'Incidencia creada', performedByName: 'Andrés Solís Vega', createdAt: daysAgo(1) }],
    },
    {
      id: nextId('inc'),
      ...
      status: 'resuelto',
      priority: 'baja',
      reportedById: 'std-202',
      reportedByName: 'Lucía Fernández Mora',
      responsibleName: 'Ana Torres Vega',
      createdAt: daysAgo(10),
      updatedAt: daysAgo(6),
      history: [
        { id: nextId('ih'), action: 'Incidencia creada', performedByName: 'Lucía Fernández Mora', createdAt: daysAgo(10) },
