...
let USERS: ManagedUser[] = [
  ...
  { id: 'std-016', name: 'Claudia Alonso Núñez', email: 'claudia.alonso@ludiclass.com', role: 'alumno', status: 'activo', matricula: 'CMM-2025-0016', careerName: 'Administración', groupName: 'CMM-101', subjectNames: ['Clase Modelo 1 y Modelo 2'], createdAt: '2026-08-19T09:00:00.000Z', lastLoginAt: minutesAgo(40), isRealAccount: false, history: [historyEntry('Cuenta creada', 'Sistema', 0)] },
